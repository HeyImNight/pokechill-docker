...
function updatePreviewTeam(){
    ...
    div.innerHTML = `
        ...
        <div class="team-move-editor" id="team-${i}-move-editor" >
    ...
    //new move editor button
    document.getElementById(`team-${i}-move-editor`).addEventListener("click", e => { 
        tooltipData("pkmnEditor", currentTeam[i].pkmn)
    })
